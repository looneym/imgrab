...
var Nav = function (_react$Component) {
  ...
  _createClass(Nav, [{
    ...
    value: function testGet() {
      _axios2.default.get('http://127.0.0.1:5000/api/images').then(function (response) {
